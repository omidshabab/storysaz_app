...
class _DraggableTextState extends State<DraggableText>
  ...
  void _updateElement() {
    final updatedElement = TextElement(
      ...
      index: widget.textElement.index,
    );
          ...
          showGeneralDialog(
            ...
            pageBuilder: (context, animation, secondaryAnimation) {
              final TextEditingController textEditingController =
                  TextEditingController(text: widget.textElement.text);
              bool hasTextBackgroundLocal = widget.textElement.hasBackground;
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 10),
                                    AppIconButton(
                                      icon: Ionicons.radio_button_off_outline,
                                      onPressed: () {
                                        setStateLocal(() {
                                    ...
                                    AppIconButton(
                                      ...
                                      onPressed: () {
                                        final updatedTextElement = TextElement(
                                          id: widget.textElement.id,
                                          x: widget.textElement.x,
                                          y: widget.textElement.y,
                                          text: textEditingController.text,
                                          fontSize: widget.textElement.fontSize,
                                          color: widget.textElement.color,
                                          rotation: widget.textElement.rotation,
                                          scale: widget.textElement.scale,
                                          hasBackground: hasTextBackgroundLocal,
                                          index: widget.textElement.index,
                                        );
                                        widget.onChanged(updatedTextElement);
                                        Navigator.pop(context);
                                      },
                                      color: widget.displayColor,
                                      borderColor:
                              ...
                              Expanded(
                                child: Center(
                                  child: IntrinsicWidth(
                                    child: Container(
                                      decoration: hasTextBackgroundLocal
                                          ? BoxDecoration(
                                              color:
                                                  widget.parentBackgroundColor ==
                                                          const Color(
                                      ...
                                      child: TextField(
                                        ...
                                        cursorColor: widget.displayColor,
                                        minLines: 1,
                                        maxLines: 10,
                                        style: TextStyle(
                                          color: widget.displayColor,
        ...
        onScaleUpdate: (details) {
          setState(() {
            if (details.scale != 1.0) {
              _scale =
                  (widget.textElement.scale * details.scale).clamp(0.5, 3.0);
            }
